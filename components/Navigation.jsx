          ...
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
            <div className="flex w-full items-center justify-between">
              ...
              <div className="flex grow justify-end mr-2 hidden lg:flex">
                <input
                  className="flex h-10 w-[180px] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-1 text-black focus-visible:outline-black rounded-md bg-gray-100 px-3 py-2 text-sm placeholder:text-gray-600 focus:outline-none focus:ring-1 focus:ring-black/30 focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50"
                  type="text"
                  placeholder="Search"
                />
              ...
              <div className="flex lg:hidden">
                <button
                  onClick={toggleMenu}
                  className="rounded-lg bg-black p-2 text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white"
                >
            ...
            {/* Render MultiDropdowns only on large screens */}
