...
export default async function DemoPage() {
  ...
  return (
    ...
    <div className="w-full max-w-screen-lg bg-primary_color2  rounded-lg shadow-lg px-2" >
    <ExampleNavbarThree></ExampleNavbarThree>
    <h2 className="text-4xl font-bold text-center text-black mb-12 mt-4">Upcoming Bootcamp</h2>
